...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("getclusternodes")
        .setDescription("Return the list of nodes that are currently participating in the cluster")
        .setDMPermission(false),
    async execute(interaction, client, connection) {
        await interaction.deferReply()
        try {
            const response = await connection.getClusterNodes()
